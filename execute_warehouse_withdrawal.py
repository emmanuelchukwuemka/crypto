"""
Execute Withdrawal Through Splits WarehouseClient
This script executes a complete two-step withdrawal process:
1. Withdraw from source to Splits WarehouseClient (batching)
2. Release from WarehouseClient to your wallet
"""
...
async def execute_warehouse_withdrawal():
    """Execute complete two-step withdrawal through WarehouseClient"""
    print("🚀 Splits Warehouse Withdrawal Process")
    print("=" * 50)
    ...
    try:
        ...
        if not warehouse_status['has_claimable_funds']:
            ...
            print("💡 Tip: Funds need to be in the WarehouseClient before they can be withdrawn.")
            return
        ...
        if result['status'] == 'complete_success':
            ...
            print(f"\n💡 Your tokens are in the WarehouseClient. You can try manual release later.")
